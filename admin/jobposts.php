        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Job Vacancy List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Below are the list posted job vacancies</h3>
              </div>
              ...
              <br>
              <div class="pl-5">
                <a href="addpost.php"><button class="btn btn-success">+ Add new post</button></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th>Job Required Qualifications</th>
                    <th>Edit Post</th>
                    <th>Delete Post</th>
                  </tr>
                  </thead>
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['job_qualifications']; ?></td>
                    <td><?php echo $row['job_req_qualif']; ?></td>
                    <td class="text-center"><a href="editpost.php?id=<?php echo $row['job_id']; ?>"><button class="btn btn-warning">Edit</button></a></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p><b><h5>Do you want to delete record?</h5></b></p>
        </div>
