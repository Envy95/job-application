    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <?php } ?>
              <div class="pl-5">
                <a href="adduser.php"><button class="btn btn-success">+ Add new user</button></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class="text-center"><a href="editemployee.php?id=<?php echo $row['id']; ?>"><button class="btn btn-warning">Edit</button></a></td>
