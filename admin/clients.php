          ...
          <div class="col-sm-6">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Below are the list of our company clients</h3>
              </div>
              ...
              <br>
              <div class="pl-5">
                <a href="addclient.php"><button class="btn btn-success">+ Add new client</button></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class="text-center"><a href="editclient.php?id=<?php echo $row['client_id']; ?>"><button class="btn btn-warning">Edit</button></a></td>
