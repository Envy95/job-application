    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Below are the list of active employees</h3>
              </div><br>
          ...
          <?php } ?>
              <div class="pl-5">
                <a href="addemployee.php"><button class="btn btn-success">+ Add new employee</button></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class="text-center"><a href="editemployee.php?id=<?php echo $row['emp_id']; ?>"><button class="btn btn-warning">Edit</button></a></td>
