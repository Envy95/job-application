...
$conn = connection();
$sql = "SELECT * FROM applicants ORDER BY app_id DESC";
          ...
          <div class="col-sm-6">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Below are the list of job applicants</h3>
              </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php do{ ?>
                  <tr>
                    <td><small><?php echo $row['uploaded_at']; ?></small></td>
                    <td><?php echo $row['last_name']; ?></td>
                    <td><?php echo $row['first_name']; ?></td>
                    <td><?php echo $row['email']; ?></td>
                    <td><?php echo $row['contact_num']; ?></td>
                    <td><?php echo $row['apply_as']; ?></td>
                   <td class="text-center"><a href=""><button class="btn btn-secondary">View Details</button></a></td>
