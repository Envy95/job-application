...
if(isset($_POST['submit'])){
  ...
  $sql = "INSERT INTO `clients`( `company_name`, `company_email`, `company_address`, `company_contact`) VALUES ('$company','$email','$address','$contact')";
  $conn->query($sql) or die ($conn->error);

  header('Location: clients.php?success=Client record added');
                ...
                <div class="card-body">
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input class="form-control" type="phone" name="contact">
                  </div>
                   <div class="card-footer">
                  <button type="submit" name="submit" class="btn btn-success">Submit</button>
              <a class="btn btn-warning" href="clients.php" role="button">Cancel</a>
