...
<nav class="navbar navbar-expand navbar-dark navbar-dark">
                      ...
                      <ul class="navbar-nav">
                        ...
                        <li class="nav-item d-none d-sm-inline-block">
                         ...
                         <li class="nav-item d-none d-sm-inline-block">
                          <a href="jobpostsuser.php" class="nav-link">Job Openings</a>
                        </li>
                         <li class="nav-item d-none d-sm-inline-block">
      ...
      <div class="card">
        <div class="card-body row">
          <div class="col-5 text-center d-flex align-items-center justify-content-center">
            <div class="">
              <h2>Admin<strong>JobApp</strong></h2>
              <p class="lead mb-5">Brgy. 61 San Jose, Maslog, Legazpi City<br>
                Phone: +639154856442<br>
                E-mail: neilagripa@gmail.com
              </p>
            </div>
          </div>
          <div class="col-7">
